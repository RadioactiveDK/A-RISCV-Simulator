...
class BTB{
  ...
  int pc = 0,count=0,btarget=0,instructCount=0,dataCount=0,controlCount=0,stallCount=0,dataHazard=0,contolHazard=0,misPredict=0,dataStalls=0,controlStalls=0;
  bool 
      knob1=true,
      knob2=true,
      running=true,
